module.exports = {
  ...
  'Gautama Buddha': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/SeatedBuddha.jpg/34px-SeatedBuddha.jpg',
    common: 'Buda'
  },
  Dōgen: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Dogen.jpg/29px-Dogen.jpg',
    common: 'Dogen'
  },
  Isus: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Christus_Ravenna_Mosaic.jpg/40px-Christus_Ravenna_Mosaic.jpg',
    common: 'Ješua'
  },
  'Jiddu Krishnamurti': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Jiddu_Krishnamurti_01.jpg/38px-Jiddu_Krishnamurti_01.jpg',
    common: 'Krišnamurti'
  },
  Konfucije: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Confucius_Statue_at_the_Confucius_Temple.jpg/33px-Confucius_Statue_at_the_Confucius_Temple.jpg',
    common: 'Kong Fu C\''
  },
  'Lao Tzu': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Zhang_Lu-Laozi_Riding_an_Ox.jpg/27px-Zhang_Lu-Laozi_Riding_an_Ox.jpg',
    common: 'Lao C\''
  },
  Linji: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/RinzaiGigen.jpg/34px-RinzaiGigen.jpg',
    common: 'Linči'
  },
  Solomon: {
    src: '',
  ...
  'Zhuang Zhou': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Trang_T%E1%BB%AD.jpeg/36px-Trang_T%E1%BB%AD.jpeg',
    common: 'Čuang C\''
  },
  'Antonije Veliki': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/StAnthony.jpg/25px-StAnthony.jpg',
    ms: 'Antony Veliky'
  },
  'Ađan Ča': {
  ...
  'Isak Sirin': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Isak_Sirin.jpg/34px-Isak_Sirin.jpg',
    ms: 'Isaak Sirijsky'
  },
  'Johanan Krstitelj': {
  ...
  'Maksim Ispovednik': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Maxim_Grek_icon.jpg/36px-Maxim_Grek_icon.jpg',
  ...
  'Simeon Novi Teolog': {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Symeon_the_New_Theologian.jpg/30px-Symeon_the_New_Theologian.jpg',
  ...
  Pitagora: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Kapitolinischer_Pythagoras_adjusted.jpg/37px-Kapitolinischer_Pythagoras_adjusted.jpg'
  },
  Zaratustra: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Zoroaster_1.jpg/37px-Zoroaster_1.jpg',
    common: 'Zaratuštra'
  },
  Heraklit: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Heraclitus_of_Ephesius._Wellcome_M0000762.jpg/50px-Heraclitus_of_Ephesius._Wellcome_M0000762.jpg'
  }
}
